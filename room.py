...
class Roombooking:
    def __init__(self,root):
        ...
        entry_contact=ttk.Entry(labelframeleft,textvariable=self.var_contact,width=20,font=("arial",13,"bold"))   #ttk used for stylish 
        ...
        txt_Check_out=ttk.Entry(labelframeleft,textvariable=self.var_checkout,width=29,font=("arial",13,"bold"))   #ttk used for stylish 
...
#RoomAvailable
        ...
        txtMeal=ttk.Entry(labelframeleft,textvariable=self.var_meal,width=29,font=("arial",13,"bold"))   #ttk used for stylish 
        txtMeal.grid(row=5,column=1)

        #No of Days
        lblNoofDays=Label(labelframeleft,text="No of Days:",font=("arial",12,"bold"),padx=2,pady=6)
        lblNoofDays.grid(row=6,column=0,sticky=W)
        txtNoofDays=ttk.Entry(labelframeleft,textvariable=self.var_noofdays,width=29,font=("arial",13,"bold"))   #ttk used for stylish 
        ...
        txtNoofDays=ttk.Entry(labelframeleft,textvariable=self.var_paidtax,width=29,font=("arial",13,"bold"))   #ttk used for stylish 
        ...
        txtNoofDays=ttk.Entry(labelframeleft,textvariable=self.var_actualtotal,width=29,font=("arial",13,"bold"))   #ttk used for stylish 
        ...
        txtIdNumber=ttk.Entry(labelframeleft,textvariable=self.var_total,width=29,font=("arial",13,"bold"))   #ttk used for stylish 
...
# ==================================ALL DATA FETCH========================================
    ...
    def Fetch_contact(self):
        if self.var_contact.get()=="":
            messagebox.showerror("Error","Please enter Contact Number",self.root)
        else:
            conn=mysql.connector.connect(host="localhost",user="root",password="Bansal@2021",database="hms")
            my_cursor=conn.cursor()   
